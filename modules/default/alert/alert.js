...
Module.register("alert", {
	...
	show_alert: function (params, sender) {
		...
		if (typeof params.imageHeight === "undefined") {
			params.imageHeight = "80%";
		}
		if (typeof params.imageUrl === "undefined" && typeof params.imageFA === "undefined") {
			params.imageUrl = null;
		} else if (typeof params.imageFA === "undefined") {
			image = "<img src='" + params.imageUrl.toString() + "' height='" + params.imageHeight.toString() + "' style='margin-bottom: 10px;'/> &nbsp; ";
...
*/
		...
		var message = "";
		if (params.title) {
			message += "<span class='thin dimmed slarge'>" + params.title + "</span>";
		}
		if (params.message) {
			if (message !== "") {
				message += "<br />";
			...
			message += "<span class='light bright medium'>" + params.message + "</span>";
		}
