...
//          "Digi24"    : "https://m.digi24.ro/rss",
    ...
    newsfeed: function() {
        var feedURLs = this.defaults.feeds;
        var feedMaxAge = this.defaults.feedMaxAge;
        var lengthDescription = this.defaults.lengthDescription;
        ...
        $(document).ready(function($) {
            ...
            function fetchNews() {
                ...
                setTimeout(fetchNews, this.defaults.fetchNews);
            }
            fetchNews();
...
//                  $(".RSS").updateWithTextForce(rssinfo, 2000);
            ...
            function addStoryForFeed(stories, oldestDate, story) {
        		var pubDate = moment(story.find("pubDate").text(), "HH:mm:ss");
        		...
        		if(oldestDate.diff(pubDate) < 0){
        			stories.push("<span class=\"date\"> - " + pubDate.toNow() + ":</span><br><span class=\"title\">" + title + "</span> &bull; <span class=\"desc\">" + desc + "</span>");
                }
            }(
            function showNews() {
