...
Module.register("timer", {
	...
	dimmer: function() {
		...
		if (this.config.dimmMode) { if (this.config.fadeMode) {
				if (now >= before && now < night) {
					...
					this.sendNotification("NIGHT_NOTIFICATION", this.opacity)
	...
	notification: function() {
		...
		if (this.config.sharpMode) {
			if ((now == "22:59:59") || (now == "23:59:59") || (now == "00:59:59")) {
			...
			} else if (now == "01:59:59" || now == "02:59:59" || now == "03:59:59") {
			...
			} else if (now == "04:59:59" || now == "05:59:59" || now == "06:59:59" || now == "07:59:59" || now == "08:59:59" || now == "09:59:59" || now == "10:59:59") {
			...
			} else if (now == "11:59:59" || now == "12:59:59" || now == "13:59:59") {
			...
			} else if (now == "14:59:59" || now == "15:59:59" || now == "16:59:59") {
			...
			} else if (now == "17:59:59" || now == "18:59:59" || now == "19:59:59" || now == "20:59:59" || now == "21:59:59") {
		...
		if (this.config.dateMode) { 
			if (date == "25.12 00:05" || date == "26.12 00:05") {
			...
			} else if (date == "01.01 00:05" || date == "02.01 00:05") {
			...
			} else if (date == this.config.birthday1 + " 00:05") {
			...
			} else if (date == this.config.birthday2 + " 00:05") {
			...
			} else if (date == this.config.birthday3 + " 00:05") {
