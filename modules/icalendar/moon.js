...
{
	var ical = $("<span/>").html(text);
	if (force || ($(this).html() != ical.html()))
	{
...
calendar.updateCalendar = function(eventList){
	...
	for (var i in eventList){
		...
		row.append($("<td/>").html(e.description.replace("New moon", "Lună nouă la").replace("Full moon", "Lună plină la").replace("First quarter", "Primul pătrar la").replace("Last quarter", "Ultimul pătrar la")).addClass("description"));
