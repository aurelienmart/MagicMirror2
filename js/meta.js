...
+ "css & js, fonts sizes, icons & well structured folders, based on MagicMirror² open source full of bugs core framework.\">"
...
+ "Currentweather https://github.com/hangorazvan/weather_plus, Weatherforecast https://github.com/hangorazvan/forecast_plus, Clock https://"
+ "github.com/hangorazvan/clock_plus; Some 3rd party modified modules: multi monthly calendar, random_quotes; My own test developed modules: "
+ "swatch.beat https://github.com/hangorazvan/swatch, lifecounter https://github.com/hangorazvan/lifecounter, notification https://github.com/"
...
+ "<meta name=\"Project\" content=\"Without fucking local node.js, without stupid Retardberry Pi, without any donation, without pointless or "
+ "religious nonsens modules and other wierd software from so-called developers struggling to break into a world that has nothing to do with their IQ "
+ "level, with their free time achievements which remain hidden on an obscure server, like idiot asian nazi eouia. And most important without any help "
+ "from amateur dudes of forum community. When I needed support, no one gave me an answer. They are sometimes so fucking ignorant and incompetent "
